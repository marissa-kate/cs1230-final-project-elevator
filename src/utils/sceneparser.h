...
struct RenderData {
    ...
    std::vector<PrimitiveType> shape_types;
};
...
public:
    ...
    static void parseHelper(SceneNode *scenenode, RenderData &renderData, glm::mat4 cumulative_transformation_matrix);
    static std::vector<PrimitiveType> shape_type_helper(std::vector<RenderShapeData> shape_data);
};
